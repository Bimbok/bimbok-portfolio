    ...
    <section id="skills" className="py-24 px-4 relative" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            className={`text-xl ${darkMode ? "text-gray-300" : "text-gray-700"} max-w-2xl mx-auto font-light`}
          >
            A versatile arsenal of technologies used to build scalable and
        ...
        >
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div
                className={`absolute -right-10 -top-10 w-32 h-32 bg-gradient-to-br ${skill.color} opacity-0 group-hover:opacity-10 transition-opacity rounded-full blur-3xl`}
              />
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div
                  className={`w-full h-2 rounded-full ${darkMode ? "bg-white/10" : "bg-black/5"} overflow-hidden mb-2`}
                >
                  <motion.div
                ...
                <span
                  className={`text-sm font-bold tracking-tighter ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                >
                  {skill.level}% MASTERY
                </span>
              </div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
              ...
              <div>
                ...
                <p
                  className={`text-lg ${darkMode ? "text-gray-400" : "text-gray-600"} font-light leading-relaxed`}
                >
                  Power-user setup with{" "}
                  <span className="text-pink-500 font-bold">
                    Neovim (LazyVim)
                  </span>
                  ,
                  <span className="text-purple-500 font-bold"> WSL Ubuntu</span>
                  , and
                  <span className="text-blue-500 font-bold"> Arch Linux</span>.
                  Engineered for maximum velocity and pixel-perfect precision.
                </p>
              </div>
              <div className="flex gap-4">
                <Layers
                  className={`w-12 h-12 opacity-10 ${darkMode ? "text-white" : "text-black"}`}
                />
              </div>
            </div>
          </div>
