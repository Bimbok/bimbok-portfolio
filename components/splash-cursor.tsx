...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    if (!ext.formatRGBA || !ext.formatRG || !ext.formatR || !ext.halfFloatTexType) return
    ...
    function handleFirstMouseMove(e: MouseEvent) {
      ...
      body.removeEventListener('mousemove', handleFirstMouseMove);
    }
    ...
    function handleFirstTouchStart(e: TouchEvent) {
      ...
      body.removeEventListener('touchstart', handleFirstTouchStart);
    }
    ...
    body.addEventListener('mousemove', handleFirstMouseMove);
    window.addEventListener('mousemove', handleMouseMove);
    body.addEventListener('touchstart', handleFirstTouchStart);
  ...
  return (
    <div aria-hidden="true" className="fixed inset-0 z-40 pointer-events-none">
